...
def get_args():
    ...
    parser.add_argument("--cuda", default=3, type=int, help="Which GPU to train.")
    ...
    parser.add_argument("--debug", default=0, type=int, help="verbose log")
    ...
    parser.add_argument("--lr", default=0.00005, type=float, help="Learning rate for Model1")
