...
class End2EndAugmentation(object):
    def __init__(self, dataset, txt_file, root_dir, parts_root_dir, resize, stage):
...
class Stage1Augmentation(object):
    def __init__(self, dataset, txt_file, root_dir, parts_root_dir, resize, stage='other'):
        self.augmentation_name = ['origin', 'choice1', 'choice2', 'choice3', 'choice4']
        self.randomchoice = None
        self.transforms = None
        self.transforms_list = None
